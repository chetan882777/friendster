...
<div class="sizer" style="background-color: #f1f1f1">
	<div class="top-image-holder">
		...
		<p class="load-more">Create Friends :</p>
                    ...
                    <% int list =Integer.parseInt(request.getParameter("LoadBtn"));
                        int z=0;
                        try 
                        {    //-----try-1  
                        int a1[] = new int[100];
                        count = 0;
                        Class .forName("com.mysql.jdbc.Driver");
                        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/mathmaker","root","");  //databse connectivity                                                                                               
                        Statement stmt=(Statement) con.createStatement();
	...
	<a  href="findFriend2.jsp?LoadBtn=<%out.print(list);%>" style="cursor:pointer" title="Find more friends">	
		<p class="load-more">Load More</p></a>
             ...
             {
             %>
             <p class="load-more">NO more to show!</p>
             <%
             }
             %>
	</div>
