...
%>
<body style="background:none" onload="positionSizer()" onunload="logOff()">
	<div class="topnav1">
...
<script type="text/javascript">
  ...
  function logOff()
    {	var y = "//";
    var z = "<";
       var x = document.getElementbyId("logOff");
       x.innerHTML = 
      	z+"% try{\n\
Class .forName(\"com.mysql.jdbc.Driver\");\n\
Connection con=DriverManager.getConnection(\"jdbc:mysql:"+y+"localhost:3306/olympus\",\"root\",\"\");\n\
Statement stmt=(Statement) con.createStatement();\n\
...
out.print(\"----date:\"+date);\n\
stmt.executeUpdate(\"UPDATE `logged` SET `status` = '\"+0+\"', `timeOut` = '\"+date+\"'  WHERE `logged`.`UID` = \"+UID);\n\
}\n\
catch(Exception tx){out.print(\"-----failed\");}%>";
    }
</script>
