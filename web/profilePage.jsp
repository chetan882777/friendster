			...
			<div class="grid" style="width: 400px;margin: 50px 10px 130px 10px;">
				<div class="info-text-hold">
					<p class="info-text">personal info 
                                           <a  href="editProfile.jsp?action2Btn=<%out.print(UID);%>" style="cursor:pointer; color: slateblue" title="Accept Request">	
                                               <i class="fas fa-cog" style="float: right;"></i></a>
						</p>
				</div>
				<div class="info-pad">
					<div class="row">
		...
		<div class="grid-hold">
                    <%  try{
                        ...
                        {  
                            ...
                            String icon = rs.getString("icon");
                            try{
                            rs = stmt.executeQuery("select * from friends where iUID like '"+UID+"' and rUID like '"+FrndId+"'");
                            rs.next();
                            String s = rs.getString("iUID");
                                try{
                                    rs = stmt.executeQuery("select * from friends where iUID like '"+UID+"' and rUID like '"+FrndId+"' and sender like 1 and accepter like 1");
                                    rs.next();
				...
				<div class="friend-action-btn-holder">
                    ...
                    <%
                                    ...
                                    rs = stmt.executeQuery("select * from friends where iUID like '"+UID+"' and rUID like '"+FrndId+"' and sender like 1 and accepter like 0");
                                    rs.next();
                                    String s1 = rs.getString("iUID");
					...
					<div class="action-btn">
                        ...
                        <%
                            ...
                            int requestBtn = FrndId * 10 + 4;
                                ...
                                try{
                                rs = stmt.executeQuery("select * from friends where rUID like '"+UID+"' and iUID like '"+FrndId+"' and sender like 1 and accepter like 0");
                                rs.next();
                                String s = rs.getString("iUID");
                                int requestBtn = FrndId * 10 + 4;
%>
